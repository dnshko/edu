...
import {Form, Input, TimePicker, InputNumber, Button,  Divider, message} from 'antd'
import Icon from '@ant-design/icons';
import { Link, Redirect } from 'react-router-dom';
import FormItem from '../components/Quiz/FormItem';
...
class CreateQuiz extends React.Component {
        ...
        render(){
            ...
            const formItemLayout = {
              ...
              if(submit)
              return <Redirect to="/assigntest"/>
    return ( 
      <Container style={{marginTop: '50px'}}>
      <Card >
          <nav className="nav justify-content-center">
              <p className="headTitle">Create Quiz</p>
          </nav>
